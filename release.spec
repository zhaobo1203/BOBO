...
hiddenimports = [
    ...
    'wechat_decrypt_tool.key_service_retry',
    'wechat_decrypt_tool.key_store',
    'wechat_decrypt_tool.key_v4',
    'wechat_decrypt_tool.hook_injector',
    ...
    'wechat_decrypt_tool.wechat_waiter',
